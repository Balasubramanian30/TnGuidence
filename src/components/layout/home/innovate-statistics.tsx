...
import IconHandshakeFilled from '@/components/icons/hand-shake'

const Statistics: React.FC = () => {
    const [selectedLang] = useAtom(selectedLanguageAtom)
    const content = getLanguageContent(selectedLang).innovate_statistics_section

    const stats = [
        { icon: IconHandshakeFilled, text: content.business_friendly },
        { icon: UserRoundCheck, text: content.diverse },
        { icon: TrendingUp, text: content.fast_growing },
    ]
